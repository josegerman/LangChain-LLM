...
# About:
# =======================
# This code demostrates a simple streamlit app.
# It takes content from a file an saves it a Chroma vector database.
# The content from the file is passed to the LLM and used by the retriever to answer questions.
...
# streamlit run c:/_DEV/VSCode/Workspaces/lanchain-llm/6_streamlit/streamlit_basic_chroma.py
