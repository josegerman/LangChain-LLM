...
file_path = os.path.join(current_dir, "docs", "DogsCatsDiseases.csv") # <-- C:\_DEV\VSCode\Workspaces\lanchain-llm\rag\books\odyssey.txt
...
if not os.path.exists(persistent_directory):
    ...
    persistent_directory = os.path.join(db_dir, "chroma_petmed_db")
    ...
    react_docstore_prompt = hub.pull("vetincharge/petdiag") # hwchase17/react
