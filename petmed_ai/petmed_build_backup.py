...
def create_vector_db(texts, embeddings=None, collection_name="chroma"):
    ...
    if not embeddings:
        ...
        embeddings = OpenAIEmbeddings(openai_api_key='sk-proj-q5W3UsdLijEDNAV3HP45T3BlbkFJgVoJRzgYZCLuh4IELyuP', model="text-embedding-3-small")
...
def create_full_chain(retriever, openai_api_key=None, chat_memory=ChatMessageHistory()):
    model = get_model("ChatGPT", openai_api_key='sk-proj-q5W3UsdLijEDNAV3HP45T3BlbkFJgVoJRzgYZCLuh4IELyuP')
...
def get_chain(openai_api_key=None):
    ensemble_retriever = get_retriever(openai_api_key='sk-proj-q5W3UsdLijEDNAV3HP45T3BlbkFJgVoJRzgYZCLuh4IELyuP')
...
def run():
    chain = get_chain(openai_api_key='sk-proj-q5W3UsdLijEDNAV3HP45T3BlbkFJgVoJRzgYZCLuh4IELyuP')
    st.subheader("How can I help you with your cat or dog?")
