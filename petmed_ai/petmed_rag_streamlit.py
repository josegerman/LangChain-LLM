...
qa_system_prompt = (
    "You are a veterinarian for question-answering tasks. Use the following pieces of retrieved context to answer the question. If you don't know the answer, just say that you don't know. Use four sentences maximum and keep the answer concise."
    "\n\n"
    "{context}"
)
...
if question:
    ...
    result = qa_chain_default({"query":question, "chat_history": chat_history})
...
# streamlit run C:\_DEV\VSCode\Workspaces\lanchain-llm\petmed_ai\petmed_rag_streamlit.py